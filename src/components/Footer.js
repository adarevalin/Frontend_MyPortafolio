          ...
          <Col xs={12} sm={6} md={4} className="social-media">
            {/* columna de texto */}
              ...
              <div className="astro-SZ7XMLTE media-row">
                  ...
                  <Button variant="link" href="https://www.facebook.com/andresdavid.arevalo.3" className="icon" aria-label="Contactanos a nuestro whatsapp">
                    <img alt='Facebook'  src='../img/facebook.png' className='imgIcons' />
                  </Button>

                  <Button variant="link" href="https://www.instagram.com/andrsss_dvid/" className="icon" aria-label="Contactanos a nuestro whatsapp">
